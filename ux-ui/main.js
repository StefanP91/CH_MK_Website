...
//   $('#myModalFreeCourse').modal('show');
// });

// SPOTS FORM 

function openSpotsForm() {
  scriptContainer = document.getElementById('spotsFormContainer');

  const script = document.createElement('script');
  script.src = "https://akoskarova.activehosted.com/f/embed.php?id=815";
